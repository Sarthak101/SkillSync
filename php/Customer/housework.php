...
$sql = "SELECT technician_tb.empName, posts_tb.price, posts_tb.description FROM posts_tb INNER JOIN technician_tb ON posts_tb.emp_id = technician_tb.empid WHERE posts_tb.job_title = 'Housework'";
