...
$sql = "SELECT technician_tb.empName, posts_tb.price, posts_tb.description FROM posts_tb INNER JOIN technician_tb ON posts_tb.emp_id = technician_tb.empid WHERE posts_tb.job_title = 'vehicle_repair'";
...
<?php include "cust_nav.php";?>
    ...
    <h1 style="text-align: center;">Vehicle Repair near you..</h1>
    <div class="container">
